...
- [Platform Security 적용 기준](./platform-security.md): `platform-security` `1.0.3` 소비 방식
...
6. 인증 공통 capability 연동을 바꿀 때는 [Platform Security 적용 기준](./platform-security.md)를 봅니다.
